...
// Route::put('availabel-tests.edit/{id}','AvailableTestController@edit')->name('availabel-tests.edit');
...
Route::post('test-performed','TestsPerformedController@store')->name('test-performed');
