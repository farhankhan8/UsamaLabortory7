  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
       <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $performed->start_time) }}" required>
